#!/usr/bin/env python3
"""
Optimized data collection for BTCUSDT, ETHUSDT, and ICPUSDT.
"""
...
async def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Optimized data collection for BTCUSDT, ETHUSDT, and ICPUSDT")
    parser.add_argument(
        "--duration", 
        type=int, 
        default=24, 
    ...
    if args.mainnet:
        print("⚠️  Using mainnet for BTC, ETH, ICP data collection")
