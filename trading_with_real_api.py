#!/usr/bin/env python3
"""
Trading system with real Bybit API integration for account balance monitoring.
This integrates AccountMonitor to retrieve real balance every 60 seconds.
"""
...
class RealAPITradingSystem:
    """Trading system with real Bybit API integration."""
    ...
    async def start(self):
        ...
        logger.info("Starting Real API Trading System")
        ...
        try:
            ...
            if self.account_monitor.current_balance:
                ...
                discord_notifier.send_notification(
                    title="💰 Account Balance - System Started",
                    description=f"Initial balance retrieved from Bybit API",
                    color="03b2f8",
                    fields=fields
                )
            ...
            discord_notifier.send_system_status(
                "online",
                f"Real API Trading System started with {settings.model.model_version} model\n" +
                f"Account Balance: ${self.account_monitor.current_balance.total_equity:.2f}" if self.account_monitor.current_balance else ""
            )
            
            logger.info("Real API Trading System fully started")
    ...
    async def stop(self):
        ...
        logger.info("Stopping Real API Trading System")
        self.running = False
        ...
        logger.info("Real API Trading System stopped")
...
async def main():
    """Run the real API trading system."""
    system = RealAPITradingSystem()
...
if __name__ == "__main__":
    logger.info("Starting Real API Trading Bot")
    asyncio.run(main())